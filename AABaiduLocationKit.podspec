...
#  s.dependency 'BaiduMapKit/Map'
#  s.dependency 'BaiduMapKit/Search'
#  s.dependency 'BaiduMapKit/Utils'
#  s.dependency 'BMKLocationKit'
  s.source_files  = 'AABaiduLocationKit/Classes/**/*','AABaiduLocationKit/framework/*.framework/Headers/*.h'
  ...
  s.vendored_libraries = 'AABaiduLocationKit/framework/thirdlibs/*.a'
